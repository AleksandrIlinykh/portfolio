...
export const timelineData = [
  ...
  },
  {
    ...
    text: [
      ...
      локализация и устранение ошибки в коде микроконтроллера на assembler 8086, заставлявшей приборы периодически выходить из строя в течении нескольких лет!`,
    ],
  },
  {
    id: 2,
    ...
    text: [
      ...
      <Link
        ...
        key={1}
      />,
      `, участвовал в разработке противоугонной системы. Помимо проектировки антенн и железа занимался рефакторингом кода микроконтроллеров на C++, 
